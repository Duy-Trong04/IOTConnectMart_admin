...
fun NavGraph(navController: NavHostController) {
    ...
    NavHost(
        ...
        composable(route=Screen.AddSlideShowScreen.route){
            AddSlideShowScreen(navController)
        }
        composable(route=Screen.AddCategoryScreen.route){
            AddCategoryScreen(navController)
        }
        composable(route=Screen.AddCamelCaseScreen.route) {
            AddCamelCaseScreen(navController)
        }
